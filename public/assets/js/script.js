(function ($) {
  ...
  function dynamicCurrentMenuClass(selector) {
    ...
    // Get the last segment (e.g. "about", "contact", "")
    ...
    selector.find("li").each(function () {
      ...
      let normalizedHref = href.replace(/^\/|\/$/g, "").split("/").pop();
    ...
    // If any li has .current child, add current to parent li
    ...
    // Home page fallback
    if ("" === FileName || "index2" === FileName || "index3" === FileName || "index-dark" === FileName) {
